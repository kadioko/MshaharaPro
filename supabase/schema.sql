...
create policy "Members can read compensation" on employee_compensation for select using (is_org_member(organization_id));
...
create policy "Members can read payroll runs" on payroll_runs for select using (is_org_member(organization_id));
...
create policy "Members can read payslips" on payslips for select using (is_org_member(organization_id));
...
create policy "Members can read reports" on reports for select using (is_org_member(organization_id));
...
create policy "Members can read documents" on documents for select using (is_org_member(organization_id));
...
create policy "Members can read audit logs" on audit_logs for select using (is_org_member(organization_id));
