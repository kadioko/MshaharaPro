...
create table payroll_variance_settings (
...
create index on organization_subscriptions (snippe_session_reference);
create index on billing_events (organization_id, created_at desc);
create index on billing_events (provider_reference);
create index on payroll_unlock_requests (organization_id, payroll_run_id, status, created_at);
